                                ...
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      <a href="/userbiodata/verifikasi/{{ $u->id }}/aktif"><button class="btn btn-warning" style="float:right;">Verifikasi!</button></a>
                                      <a href="/userbiodata/verifikasi/{{ $u->id }}/tolak"><button class="btn btn-danger" style="float:right;">Tolak!</button></a>
